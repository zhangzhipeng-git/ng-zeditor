(function (global, factory) {
    ...
    var UIAnnexComponent = /** @class */ (function () {
        ...
        UIAnnexComponent.prototype.selectFile = function () {
            // 需要先设置宽度和高度
            /** @type {?} */
            var num = /^[1-9]\d{1,3}(px|rem|em|vw|vh|%)?|auto|inherit|unset$/i;
        ...
        UIAnnexComponent.prototype.getAudioHTML = function (src) {
            ...
            // tslint:disable-next-line: max-line-length
            /** @type {?} */
            var html = '<p><audio controls style="display:inline-block;height:' + this.height + ';width:' + this.width + ';">';
        ...
        UIAnnexComponent.prototype.getVideoHTML = function (src) {
            ...
            // tslint:disable-next-line: max-line-length
            /** @type {?} */
            var html = '<p><video controls style="display:inline-block;height:' + this.height + ';width:' + this.width + ';">';
            for (var i = 0, len = arr.length; i < len; i++) {
                html += '<source src="' + src + '" type="' + arr[i] + '">';
            }
    ...
    var AppZeditorComponent = /** @class */ (function () {
        ...
        Object.defineProperty(AppZeditorComponent.prototype, "vhtml", {
            /**
             * @return {?}
             */
            get: function () {
         ...
         * @return {?}
         */
        AppZeditorComponent.prototype.history = function (e) {
            var _this = this;
            this.ensureFocus(e);
             ...
             */function () {
                // 重设光标
                CursorUtil.setSelectionToElement(_this.pannel, false);
                _this.setRange();
                _this.autoActive();
            }));
        ...
        AppZeditorComponent.prototype.pannelOnClick = function () {
            ...
            setTimeout(( /**
             * @return {?}
             */function () { return _this.detectCode(); }));
        };
        /**
        ...
        AppZeditorComponent.prototype.pannelOnPaste = function (e) {
            ...
            /** @type {?} */
            var obj = CommonUtil.isIE() ? window : e;
         ...
         * @return {?}
         */
        AppZeditorComponent.prototype.setDefaultFormat = function () {
            this.cmd('formatBlock', false, this.formatBlock);
            this.cmd('fontName', false, this.fontFamily.value);
         ...
         */
        AppZeditorComponent.prototype.detectCode = function () {
            var _this = this;
            this.pannelFocus();
            /** @type {?} */
             ...
             */function () {
                ...
                if (range.cloneContents) { // 新标准
                    // 新标准
                    /** @type {?} */
                    var ele = range.cloneContents();
                    /** @type {?} */
                    var childs = CommonUtil.getAllChilds(ele);
                    for (var i = 0, len = childs.length; i < len; i++) {
